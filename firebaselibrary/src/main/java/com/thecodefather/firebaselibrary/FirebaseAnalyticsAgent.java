...
public class FirebaseAnalyticsAgent extends BaseAnalyticsAgent {
    private static final String TAG = FirebaseAnalyticsAgent.class.getSimpleName();
    ...
    public void initializeAnalyticsAgent(Context context) {
        ...
        Log.wtf("FIRE the token" , "is: " +token);
        firebaseAnalytics = FirebaseAnalytics.getInstance(context);
        if (StringUtil.isNotEmpty(storage.getID()) && shouldSetClientId) {
            firebaseAnalytics.setUserId(storage.getID());
        }
    }
